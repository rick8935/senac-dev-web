...
namespace MeuCorre.infra.Migrations
{
    ...
    [Migration("20251004001733_AddSeed")]
            ...
            modelBuilder.Entity("MeuCorre.Domain.Entities.Conta", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f3b2a1c4-d5e6-4789-8b0c-2d3e4f5a6b7d"),
                            Ativo = true,
                            DataCriacao = new DateTime(2025, 10, 3, 21, 17, 32, 807, DateTimeKind.Local).AddTicks(6401),
                            Nome = "Conta Carteira",
                            Saldo = 0m,
                            Tipo = 1,
                            UsuarioId = new Guid("da3b9f4c-8e6a-4a4f-9e6b-1c2d3e4f5a6b")
            ...
            modelBuilder.Entity("MeuCorre.Domain.Entities.Usuario", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Ativo = true,
                            DataCriacao = new DateTime(2025, 10, 3, 21, 17, 32, 807, DateTimeKind.Local).AddTicks(6336),
                            DataNascimento = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified).AddTicks(1978),
