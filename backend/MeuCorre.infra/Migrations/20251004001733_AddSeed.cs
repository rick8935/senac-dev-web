    ...
    public partial class AddSeed : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("da3b9f4c-8e6a-4a4f-9e6b-1c2d3e4f5a6b"), true, null, new DateTime(2025, 10, 3, 21, 17, 32, 807, DateTimeKind.Local).AddTicks(6336), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified).AddTicks(1978), "rick1@gmail.com", "Rick", "@123ab" });

            migrationBuilder.InsertData(
                table: "Categorias",
                columns: new[] { "Id", "Ativo", "Cor", "DataAtualizacao", "DataCriacao", "Descricao", "Icone", "Nome", "TipoTransacao", "UsuarioId" },
                values: new object[,]
                {
            ...
            migrationBuilder.InsertData(
                table: "Contas",
                columns: new[] { "Id", "Ativo", "Cor", "DataAtualizacao", "DataCriacao", "DiaFechamento", "DiaVencimento", "Icone", "Limite", "LimiteValor", "Nome", "Saldo", "Tipo", "UsuarioId" },
                values: new object[] { new Guid("f3b2a1c4-d5e6-4789-8b0c-2d3e4f5a6b7d"), true, null, null, new DateTime(2025, 10, 3, 21, 17, 32, 807, DateTimeKind.Local).AddTicks(6401), null, null, null, null, null, "Conta Carteira", 0m, 1, new Guid("da3b9f4c-8e6a-4a4f-9e6b-1c2d3e4f5a6b") });
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DeleteData(
                table: "Contas",
                keyColumn: "Id",
                keyValue: new Guid("f3b2a1c4-d5e6-4789-8b0c-2d3e4f5a6b7d"));
